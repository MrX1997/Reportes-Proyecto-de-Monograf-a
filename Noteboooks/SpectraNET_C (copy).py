...
def train(model, criterion, optimizer, scheduler, epochs):
    for epoch in range(epochs):
        ...
        for phase in phases:
            ...
            epoch_acc = running_accuracy / data_sizes[phase]
            if(phase=='train'):
...
plt.scatter(epoch,loss_val,label='Validation loss')
plt.scatter(epoch,loss_train,label='Train loss',color='r')
plt.xlabel('Epochs')
plt.ylabel('Loss')
plt.title('Train-Validation Epochs Loss - Classification')
plt.legend()
plt.savefig('Train-Validation_Epoch_Loss_Classification_.jpg')
plt.close()
...
plt.legend()
plt.savefig('Train-Validation_Epochs_Accuracy_Classification_.jpg')
plt.close()
