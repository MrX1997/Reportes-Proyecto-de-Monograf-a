    ...
    for epoch in range(epochs):
        ...
        for phase in phases:
            ...
            for dat, target in data_loaders[phase]:
                ...
                #batch_idx+=1
                #running_accuracy += torch.sum(outputs == target.data)
...
plt.legend()
plt.savefig('Train-Validation_Epochs_Loss_Regression_.jpg')
plt.close()
...
plt.legend()
plt.savefig('Train-Validation_LR_Loss_Regression_.jpg')
plt.close()
